...
public class DBEstSingleResultFromDbmsQueryResult
    ...
    public DBEstSingleResultFromDbmsQueryResult(DbmsQueryResult result) {
        super();
        if (result == null) {
    ...
    public DBEstSingleResultFromDbmsQueryResult(DbmsQueryResult result, boolean asIs) {
    ...
    public static DBEstSingleResultFromDbmsQueryResult empty() {
        return new DBEstSingleResultFromDbmsQueryResult(null);
    }
